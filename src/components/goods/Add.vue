        ...
        >
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item
              label="商品价格"
              prop="goods_price"
              :rules="addFormRules.goods_price"
            >
            ...
            <el-form-item
              label="商品重量"
              prop="goods_weight"
              :rules="addFormRules.goods_weight"
            >
            ...
            <el-form-item
              label="商品数量"
              prop="goods_number"
              :rules="addFormRules.goods_number"
            >
...
export default {
  ...
  methods: {
    ...
    handleRemove(file) {
      ...
      // 3 调用数组的splice 方法,把图片信息对象从pics 数组中移除
